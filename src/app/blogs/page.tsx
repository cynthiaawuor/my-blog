  ...
  return (
    <div className="min-h-screen">
      ...
      {blogPosts.map((post) => (
        <div
          key={post.id}
          className="card w-full md:w-[80%] mx-auto mb-8 card-sm shadow-lg border border-black/5 hover:border-(--primary-red)/20"
        >
          ...
          <div className="card-body flex flex-col xl:flex-row">
            ...
            <div className="flex items-center p-2">
              ...
              <Link
                href={`/editor`}
                className="btn btn-link text-black/50 hover: hover:bg-black/10"
              >
